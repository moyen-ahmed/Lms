...
<body>
    ...
    <center><h4 class="text-warning">Manage Catagory</h4><br></center>
		<div class="row">
                    ...
                    <?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
                                ...
                                <<td><button class="btn btn-outline-warning"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
								<button class="btn btn-outline-warning"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>">Delete</a></button></td>
