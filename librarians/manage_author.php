		...
		<div class="row">
			...
			<div class="col-md-8">
				<table class="table table-bordered table-warning table-hover">
                    ...
                    <?php
                    //datbase theka data show korano hoecaha ekane//
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><?php echo $row['author_full_name'];?></td>
                                <td><button class="btn-outline-danger btn-lg"><a href="edit_author.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
								<button class="btn-outline-danger btn-lg"><a href="delete_author.php?aid=<?php echo $row['author_id'];?>">Delete</a></button></td>
