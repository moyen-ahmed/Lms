...
if (isset($_POST['submit2']) && !empty($_POST['search'])) {
    ...
    $query = "SELECT * FROM proceedings LEFT JOIN library_branches on proceedings.lib_id=library_branches.branch_id
              WHERE conference_name LIKE '%$search%' 
              OR type LIKE '%$search%' ";
} else {
    $query = "SELECT * FROM proceedings LEFT JOIN library_branches on proceedings.lib_id=library_branches.branch_id;";
}
            ...
            <table class="table table-bordered table-danger table-hover">
                ...
                ?>
                        <tr class="animate-slidein">
                            <td><?php echo $id; ?></td>
                            <td><?php echo $conference_name; ?></td>
                            <td><?php echo $conference_topic; ?></td>
