		...
		<div class="row">
            ...
            <form action="" method="post">
					<div class="form-group">
						<label for="name">CAuthor ID:</label>
						<input type="text" class="form-control" name="author_id" value="<?php echo $author_id; ?>" disabled required>
					</div>
                    <div class="form-group">
						<label for="name">Author Full Name:</label>
						<input type="text" class="form-control" name="author_full_name" value="<?php echo $author_full_name; ?>" required>
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control" name="biography" value="<?php echo $biography; ?>" required>
					</div>
                
					<button type="submit" name="update_author" class="btn-outline-danger btn-lg">Update Author</button>
				</form>
			</div>
...
<?php
	if(isset($_POST['update_author'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update authors set author_full_name='$_POST[author_full_name]',nationality='$_POST[nationality]',biography='$_POST[biography]' where author_id=$_GET[aid]";
		$query_run = mysqli_query($connection,$query);
