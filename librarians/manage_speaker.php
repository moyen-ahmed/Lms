                    ...
                    <?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
                                ...
                                <td><button class="btn btn-outline-success" name=""><a href="edit_s.php?bn=<?php echo $row['book_isbn'];?>">Edit</a></button>
								<button class="btn btn-outline-warning" name=""><a href="delete_s.php?bn=<?php echo $row['book_isbn'];?>">Delete</a></button></td>
