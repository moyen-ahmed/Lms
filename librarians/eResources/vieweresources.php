...
if (isset($_POST['submit2']) && !empty($_POST['search'])) {
    ...
    $query = "SELECT * FROM eresourcesLEFT JOIN library_branches on eresources.brance_id=library_branches.branch_id
              WHERE e_name LIKE '%$search%' 
              OR `type` LIKE '%$search%' ";
} else {
    $query = "SELECT * FROM eresources LEFT JOIN library_branches on eresources.brance_id=library_branches.branch_id;";
}
?>
<!DOCTYPE html>
<html>
