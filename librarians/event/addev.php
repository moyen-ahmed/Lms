...
<?php
	if(isset($_POST['issu_book']))
	{
		...
		$query = "INSERT INTO `library_events`(`event_id`, `ename`, `branch_id`, `date`, `location`) VALUES ('','$ename','$branch_id','$date','$location')";
		$query_run = mysqli_query($connection,$query);
		#header("location:addev.php");
	}
?>
